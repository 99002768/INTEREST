...
void test_FindCompound(void) {
  CU_ASSERT(98497.32== FindCompound(10000.00,10.00,24.00));
  CU_ASSERT(110.00  == FindCompound(100.00,10.00,1.00));
  CU_ASSERT(220.00  == FindCompound(200.00,10.00,1.00));
  CU_ASSERT(330.00 == FindCompound(300.00,10.00,1.00));
